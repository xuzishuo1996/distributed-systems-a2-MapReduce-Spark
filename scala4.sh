...
echo --- Jarring
$JAVA_HOME/bin/jar -cf Task4-scala.jar Task4-scala*.class
...
time $SPARK_HOME/bin/spark-submit --master yarn --class Task4-scala --driver-memory 4g --executor-memory 4g SparkWC.jar $INPUT $OUTPUT

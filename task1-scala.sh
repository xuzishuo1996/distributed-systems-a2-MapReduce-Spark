...
echo --- Jarring
$JAVA_HOME/bin/jar -cf Task1-scala.jar Task1-scala*.class
...
time $SPARK_HOME/bin/spark-submit --master yarn --class Task1-scala --driver-memory 4g --executor-memory 4g SparkWC.jar $INPUT $OUTPUT

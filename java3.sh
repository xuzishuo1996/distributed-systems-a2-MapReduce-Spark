...
echo --- Jarring
$JAVA_HOME/bin/jar -cf Task3-java.jar Task3-java*.class
...
time $HADOOP_HOME/bin/yarn jar Task3-java.jar Task3-java -D mapreduce.map.java.opts=-Xmx4g $INPUT $OUTPUT

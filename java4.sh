...
echo --- Jarring
$JAVA_HOME/bin/jar -cf Task4-java.jar Task4-java*.class
...
time $HADOOP_HOME/bin/yarn jar Task4-java.jar Task4-java -D mapreduce.map.java.opts=-Xmx4g $INPUT $OUTPUT
